...
import {
  ...
  Alert, Grid, Chip, Divider, alpha, List, ListItem, ListItemIcon, ListItemText,
} from '@mui/material';
...
const importantInfo = [
  'Tài khoản của bạn sẽ được kích hoạt ngay sau khi đăng ký',
  'Bạn có thể bắt đầu đăng bán sản phẩm ngay lập tức',
    ...
    <SiteLayout>
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ mb: 1, color: 'text.secondary', fontSize: '0.82rem' }}>
          ...
          <Box sx={{ display: 'flex', gap: 1, mt: 1, alignItems: 'flex-start' }}>
            ...
            <Typography variant="body2" sx={{ fontSize: '0.82rem', lineHeight: 1.6 }}>
              ...
              <Box component="span" sx={{ color: '#dc2626', fontWeight: 700 }}>Thông tin sai lệch hoặc gian lận sẽ dẫn đến khóa tài khoản vĩnh viễn</Box>
            </Typography>
          </Box>
        </Alert>
        ...
        <Paper elevation={0} sx={{ p: 3.5, borderRadius: 3, border: '1px solid', borderColor: 'divider' }}>
          <Box component="form" sx={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            {/* Personal */}
            <Typography variant="subtitle2" sx={{ fontWeight: 700, mb: 2, color: '#16a34a' }}>
              Thông tin cá nhân
            </Typography>
            ...
            <TextField
              ...
              sx={{ mb: 2.5 }}
              InputProps={{
                startAdornment: <Box component="span" sx={{ mr: 1, color: 'text.secondary' }}><PersonIcon fontSize="small" /></Box>,
              }}
            />
            ...
            <Grid container spacing={2} sx={{ mb: 2.5 }}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  fullWidth
                  InputProps={{
                    startAdornment: <Box component="span" sx={{ mr: 1, color: 'text.secondary' }}><PhoneIcon fontSize="small" /></Box>,
                  }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: <Box component="span" sx={{ mr: 1, color: '#1877f2' }}><FacebookIcon fontSize="small" /></Box>,
                  }}
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2} sx={{ mb: 3 }}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  fullWidth
                  InputProps={{
                    startAdornment: <Box component="span" sx={{ mr: 1, color: 'text.secondary' }}><CreditCardIcon fontSize="small" /></Box>,
                  }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: <Box component="span" sx={{ mr: 1, color: '#26a5e4' }}><TelegramIcon fontSize="small" /></Box>,
                  }}
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2} sx={{ mb: 3 }}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: <Box component="span" sx={{ mr: 1, color: 'text.secondary' }}><AccountBalanceIcon fontSize="small" /></Box>,
                  }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
            ...
            <Alert severity="warning" variant="outlined" sx={{ borderRadius: 2, fontSize: '0.8rem', mb: 3 }}>
              Tên chủ tài khoản ngân hàng phải <strong>trùng khớp hoàn toàn</strong> với Họ và Tên ở trên. Không khớp sẽ không thể rút tiền.
            </Alert>
            ...
            >
              {[
                { label: 'Sản phẩm số', fee: '3-5%' },
                { label: 'Dịch vụ thiết kế', fee: '8-10%' },
                { label: 'Marketing / Tăng tương tác', fee: '5-8%' },
              ].map((item, i) => (
                <Box key={i} sx={{ textAlign: 'center', flex: 1 }}>
                  ...
                  <Chip
                    label={`Phí ${item.fee}`}
                    size="small"
                    sx={{ bgcolor: '#16a34a', color: 'white', fontWeight: 700, fontSize: '0.72rem', mt: 0.5 }}
                  />
                </Box>
              ))}
            </Box>
